...
public class ModHideAndSeekGameTimer : ModNetworkBehaviour
{
    private byte RPC_CLIENT_STARTSTOP;

    public Action<ModHideAndSeekGameTimer> onTimerFinished;
    public Action<ModHideAndSeekGameTimer,string> onTimerUpdated;
    ...
    {
        onTimerUpdated?.Invoke(this, GetSecondsLeftFormatted());
    }
